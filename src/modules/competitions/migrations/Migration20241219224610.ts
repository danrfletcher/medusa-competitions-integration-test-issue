...
export class Migration20241219224610 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('CREATE UNIQUE INDEX IF NOT EXISTS "IDX_geoguesser_guess_order_item_id_unique" ON "geoguesser_guess" (order_item_id) WHERE deleted_at IS NULL;');
    ...
    this.addSql('CREATE UNIQUE INDEX IF NOT EXISTS "IDX_geoguesser_image_product_variant_id_unique" ON "geoguesser_image" (product_variant_id) WHERE deleted_at IS NULL;');
